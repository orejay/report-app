...
const DailyBranchUipTrend = () => {
  ...
  const getData = async () => {
    const response = await fetch(`${baseUrl}/dailytrend/branch`);
      ...
      <Box height={!isMobile ? "75vh" : "78vh"}>
        {data.length > 0 ? (
          <Box sx={{ width: "100%", height: "100%" }}>
            ...
            <LineChart dat={data} view={view} period={"Day"} />
          </Box>
        ) : (
...
export default DailyBranchUipTrend;
