...
const MonthlyBranchUipTrend = () => {
  ...
  const getData = async () => {
    const response = await fetch(`${baseUrl}/monthlytrend/branch`);
      ...
      <Box height={!isMobile ? "75vh" : "78vh"}>
        {data.length > 0 ? (
          <Box sx={{ width: "100%", height: "100%" }}>
            ...
            <LineChart dat={data} view={view} period={"Month"} />
          </Box>
        ) : (
...
export default MonthlyBranchUipTrend;
